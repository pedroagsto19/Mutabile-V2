/*
  # Criar dados demo para o sistema

  1. Dados Demo
    - Usuários de exemplo para diferentes níveis de acesso
    - Clientes de exemplo
    - Fornecedores de exemplo
    - Projetos de exemplo com atividades
    - Atividades padrão para cada etapa

  2. Segurança
    - Todos os dados respeitam as políticas RLS existentes
    - IDs fixos para facilitar referências entre tabelas
*/
