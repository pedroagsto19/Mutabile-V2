                  ...
                  {supplier.evaluations
                    ...
                    <div key={evaluation.id} className="border border-gray-200 rounded-lg p-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-3">
                        <div>
                          <p className="text-xs text-gray-500 mb-1 text-center sm:text-left">Qualidade</p>
                          <div className="flex items-center justify-center sm:justify-start">
                            {Array.from({ length: 5 }, (_, i) => (
                              <span
                                key={i}
                                className={`text-sm ${i < evaluation.ratings.quality ? 'opacity-100' : 'opacity-30'}`}
                        ...
                        <div>
                          <p className="text-xs text-gray-500 mb-1 text-center sm:text-left">Preço</p>
                          <div className="flex items-center justify-center sm:justify-start">
                            {Array.from({ length: 5 }, (_, i) => (
                              <span
                                key={i}
                                className={`text-sm ${i < evaluation.ratings.price ? 'opacity-100' : 'opacity-30'}`}
                                style={{ marginRight: '0.125rem' }}
                              >
                                💰
                              </span>
